...
@pytest.mark.parametrize(
    "unmasked_card_or_account, masked_card_or_account",
    [
...
@pytest.mark.parametrize(
    "unmasked_card_or_account, invalid_masked_card_or_account",
    [
...
def test_get_mix_date(encrypted_date, decrypted_date):
