...
def test_filter_by_currency_usd(all_transactions):
    ...
    assert next(usd_transactions, 'Транзакций с данной валютой нет или вы ее не указали') == 'Транзакций с данной валютой нет или вы ее не указали'
...
def test_filter_by_currency(all_transactions):
    ...
    assert next(transactions, 'Транзакций с данной валютой нет или вы ее не указали') == 'Транзакций с данной валютой нет или вы ее не указали'
